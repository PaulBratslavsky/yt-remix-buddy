...
export async function generateDescription(videoId: string) {
  ...
  const synopsis_template =
    "Summarize the following text and include always include key topics summary at the end write a video description in a normal tone of voice for youtube and generate a title based on the content: {text} directions:  write in first person and outline key points and benefits";
